  ...
  return (
    <div className="pb-8">
      ...
      <div className="bg-surface px-6 pt-8 pb-6 border-b border-border">
        <h1 className="text-2xl font-bold text-text-main mb-6">Attendance</h1>
            ...
            {days.map((day, idx) => {
                ...
                return (
                    <motion.button
                        ...
                        className={`aspect-square rounded-full flex flex-col items-center justify-center text-xs font-medium relative ${
