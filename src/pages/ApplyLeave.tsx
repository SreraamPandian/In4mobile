    ...
    <div className="pb-8">
      ...
      <div className="px-6 pt-6 space-y-6">
        ...
        <div className="flex space-x-4 overflow-x-auto pb-2 scrollbar-hide -mx-6 px-6">
            {[
                { type: 'Casual', count: 12, id: 'casual', color: 'bg-blue-50 text-blue-700 border-blue-200' },
                ...
                <motion.button
                    ...
                    className={`flex-shrink-0 w-32 p-4 rounded-xl border-2 text-left transition-all ${
                        leaveType === item.id 
